...
namespace tdlpp { namespace router {
    ...
    public:
         ...
         */
        td::ClientManager::Response Receive(const double& secondsTimeout = 0) noexcept;
         ...
         */
        td::ClientManager::RequestId Send(UniqueObjectPtr<td::td_api::Function> function, const td::ClientManager::RequestId& rid = -1) noexcept;
         ...
         */
        td::ClientManager::RequestId GetLastRequestId() const noexcept { return requestId; }

        td::ClientManager::RequestId ReserveId() noexcept { return this->_getRequestId(); }
