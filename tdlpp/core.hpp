...
namespace tdlpp {
    ...
    std::shared_ptr<TdObject> cast_object(const SharedObjectPtr<td::td_api::Object>& object) {
        std::shared_ptr<TdObject> casted;

        td::td_api::downcast_call(*object, overloaded(
            [&](TdObject& obj) {
                casted = std::reinterpret_pointer_cast<TdObject>(object);
            },
            [&](auto&) {
