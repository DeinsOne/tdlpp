...
macro(setup_subproject_path_vars _NAME)
  ...
  set(SUBPROJECT_INSTALL_PATH ${TDLPP_DEPS_INSTALL_PATH}/${SUBPROJECT_NAME})

  set(SUBPROJECT_SOURCE_PATH ${TDLPP_DEPS_SOURCE_PATH}/${SUBPROJECT_NAME})
  set(SUBPROJECT_STAMP_PATH ${TDLPP_DEPS_BUILD_PATH}/${SUBPROJECT_NAME}/stamp)
  set(SUBPROJECT_BUILD_PATH ${TDLPP_DEPS_BUILD_PATH}/${SUBPROJECT_NAME}/build)
endmacro()
...
macro(build_subproject)
  ...
  ExternalProject_Add(${SUBPROJECT_NAME}
    ...
    CMAKE_ARGS
      ...
      -DCMAKE_INSTALL_INCLUDEDIR=${SUBPROJECT_INSTALL_PATH}/include
      -DCMAKE_INSTALL_LIBDIR=${SUBPROJECT_INSTALL_PATH}/lib
      -DCMAKE_INSTALL_DOCDIR=${SUBPROJECT_INSTALL_PATH}/doc
      -DCMAKE_INSTALL_BINDIR=${SUBPROJECT_INSTALL_PATH}/bin
