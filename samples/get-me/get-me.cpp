...
int main(int argc, char** argv) {
    ...
    auto tMeLinkPromise = handler->Execute(td::td_api::make_object<td::td_api::getOption>("t_me_url"));
    ...
    auto mePromise = handler->Execute(td::td_api::make_object<td::td_api::getMe>());
